...
{
	struct temp_table temp_search_key;
	temp_search_key.resistance = resistance;
	return bsearch(&temp_search_key, ttable, TEMP_TABLE_SIZE, sizeof(struct temp_table), resistance_cmp);
}
